...
export default function Footer() {
    return (
        <footer className="px-4 divide-y bg-gray-900">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <div className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <p className="text-white text-2xl font-bold mb-0 mt-2">GEAR <span className="text-red-600">ANT</span></p>
                    </div>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-2 text-center">
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase text-white text-lg" >About US</h3>
                        <ul className="space-y-1">
                            <li>
                                <p className="text-white">HCMUS GEARATN Group</p>
                            </li>
                            <li>
                                <NavLink to="/about" className='text-white'>More information 🠞</NavLink>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3 text-center">
                        <h3 className="uppercase text-white text-lg">Social media</h3>
                        <div className="flex justify-center space-x-3">
                            ...
                            <a href="#" title="Instagram" className="flex items-center p-1 text-orange-700 hover:text-orange-600">
            ...
            <div className="py-6 text-sm text-center text-white">© 2022 Company Co. All rights reserved.</div>
        </footer>
